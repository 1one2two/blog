                                ...
                                <div class="card-body" style="background-color: #f8f9fc;">
                                    <a href="/article/{{ $article->id }}">
                                        <div style="height: 170px">
                                            <h4 style="overflow: hidden; display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; max-width: 300px; ">
                                                {{ $article->title }}
                                            </h4>
                                            <div class="pt-0 font-weight-light">
                                                <div class="ml-1 float-left">
                                                    <svg height="13px" viewBox="0 0 384 384" width="14px" xmlns="http://www.w3.org/2000/svg">
